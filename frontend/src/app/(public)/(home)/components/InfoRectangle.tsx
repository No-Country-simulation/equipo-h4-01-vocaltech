...
export default function InfoRectangle() {
  return (
    ...
    <div className="bg-aqua text-deepblue py-10 pl-40 pr-96">
      <h2 className='text-3xl font-semibold overflow-hidden p-6'>¿Por qué realizar un diagnóstico inicial de tu empresa o emprendimiento?</h2>
      <ul className='text-lg font-normal p-6'>
        <li>
