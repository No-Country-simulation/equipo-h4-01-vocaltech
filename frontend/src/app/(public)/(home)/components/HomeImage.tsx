...
<div className="relative max-h-[800px] md:h-96 lg:h-96 xl:h-96 2xl:h-96 bg-transparent">
  ...
  <button className="text-xl/4 rounded-lg font-semibold bg-aqua hover:bg-white border-aqua border-2 text-deepblue m-8 absolute top-[460px] left-[150px] z-20 px-16 py-4">Quiero obtener mi diagnóstico</button>
</div>
  </>
  );
}
