  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent
        ...
        showCloseButton={showCloseButton && closeOnOverlayClick ? true : false}
      >
        {showCloseButton && (
          <button
            onClick={() => onOpenChange(false)}
            className="absolute right-4 top-4 text-3xl text-muted-foreground hover:text-foreground transition-colors"
          >
            ×
          </button>
        )}
